...
class NRSource(DataSource):
    @property
    @abstractmethod
    def nr_temperature(self) -> Sequence:
        pass

    @property
    @abstractmethod
    def nr_water_vapor(self) -> Sequence:
        pass

    @property
    @abstractmethod
    def nr_pressure(self) -> Sequence:
        pass

    @property
    @abstractmethod
    def nr_pblh(self) -> Sequence:
        pass

    @property
    @abstractmethod
    def nr_latitude(self) -> Sequence:
        pass

    @property
    @abstractmethod
    def nr_longitude(self) -> Sequence:
        pass


class NRSpec(DataSpec):
    dataset: Literal[
        "TEMPERATURE", "WATER_VAPOR", "PRESSURE", "PBLH", "LATITUDE", "LONGITUDE"
    ]

    @property
    def shape(self) -> tuple[int, ...]:
        match self.dataset:
            case "PBLH" | "LATITUDE" | "LONGITUDE":
                return (1,)
    ...
    def load_raw_slice(self, source: NRSource, start: int, end: int) -> Sequence:
