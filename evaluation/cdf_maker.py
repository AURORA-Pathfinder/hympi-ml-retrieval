...
# all_20060315.npz  all_20060615.npz  all_20060803.npz  all_20060915.npz  all_20061115.npz
# all_20060515.npz  all_20060715.npz  all_20060815.npz  all_20061015.npz  all_20061215.npz


x, y, latlon, spress = load_data(runtype, day, instr)
loaded_model = mlflow.pyfunc.load_model(f"runs:/{run_id}/model")

#print(0, np.max(latlon[0]), np.min(latlon[0]))
#print(1, np.max(latlon[1]), np.min(latlon[1]))
